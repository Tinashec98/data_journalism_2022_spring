...
*"Error in join_rows(x_key, y_key, type = type, na_equal = na_equal)"* This means that the columns have a type mismatch- one column is a character column while a nother is a number column. 
