...
wv_ppp_loans%>%
  ...
  theme(
    ...
    title = "An increase in WV's PPP Loans in April",
    x= "Date",
    y= "Total Loans",
...
state_total_loans_population %>%
  ...
  coord_flip() +
  labs(
    title = "Top 10 states by PPP loans per 100k people",
    x = "State",
    y = "Loans per 100k",
...
**A2.** The top 10 states are S. Dakota, N. Dakota, Nebraska, Georgia, Iowa, Illinois, Louisiana, Florida, Mississippi and Montana. 
...
**A3.**  There were more people who had their loans forgiven and for the most part, close to the full amount of the loan was forgiven. 
