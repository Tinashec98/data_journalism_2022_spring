...
**A5** Data for the race category wasn't collected efficiently. So, it's highly possible that many other Asian applicants didn't list their race and were therefore not included in the data. 
...
**A6** 21031; 6 loans; total=$6,819,563. It is possible that the business exists in the zip code while the owner themselves doesn't live there. 
...
**A7** 44 industries had exactly one loan. Credit card issuing and Savings Institutions are most worthy of further exploration because there would be multiple of these industries in a state as opposed to there being one tortilla factory, which is reasonable. 
```{r}
maryland_ppp_with_naics_and_demographics %>%
group_by(title)%>%
  summarize(count = n())%>%
