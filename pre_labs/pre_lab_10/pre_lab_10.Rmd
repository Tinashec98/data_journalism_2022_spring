...
**Answer** https://app.datawrapper.de/chart/ydXS8/publish#export-image
...
**Answer** A new dataset —md_counties— has been created and it shows the county names and the total number of ppp loans in each county. 
...
**Answer** The code produces a daataset with county names and the total ppp loans in each county and selects only those with more than 6 ppp loans. 
...
**Answer** The FIPS column is standardized to show 5-digit codes. 
...
**Answer** There's a dataset with matching data from md_counties and md_fips. 
...
**Answer** The map has zoomed in on Maryland counties only instead of showing the whole of the U.S. 
...
**Answer** The tooltip now shows the county and its corresponding number when hovered over. 
...
**Answer** https://datawrapper.dwcdn.net/S96O0/1/
