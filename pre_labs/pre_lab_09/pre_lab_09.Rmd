...
**Answer** 63 columns, 195,865 rows
...
**Answer** The code is going to count the number of counties with the most PPP loans and showing the top ten in descending order.  
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** A bar chart showing the ten counties with the most PPP loans and how many loans each has. 
...
**Answer** The number of loans for each county are arranged in ascending order. The county names are all meshed up together since there's not enough room on the x-axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The axes switched. The count is on the x-axis and the county name on the y-axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The background has changed to a lighter one.
...
**Answer** The library package "ggthemes" has been installed. 
...
**Answer** The color scheme is dark grey and light-blue. 
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The bar graph has a header: "Maryland Counties with Most PPP Loans."
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A dataframe of the total loans and the date they were approved. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** There is a line graph showing the total loans and the dates they were approved on. HOwever, the x-axis only has three points, 07/2020, 01/2021 and 07/2021
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The specific dates for each loan that was approved now appear on the x-axis. Because there's not enough room, each date's text overlaps the other's. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The dates on the x-axis are now legible as the alignment has been changed from horizontal to slanted vertical. 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
