...
**Answer** "Error in join_rows(x_key, y_key, type = type, na_equal = na_equal)" 
```{r}
...
**Answer** No, there is no demographic data.
...
**Answer** Yes, there is demographic data. 
...
**Answer** The average amount was $55,546.84 and the median amount was $19,949.
...
**Answer** The average amount was $89,194.67 and the median amount was $20,833.
...
**Answer** For those with rural stauts,the average amount was $44,815.22 and the median amount was $19,064.57. For those with urban status, the average amount was $55,584.05 and the median amount was $19,950. 
...
**Answer** For those with rural status the average amount was $74,463.32 and the median amount was $20,833. For those with urban status, the average amount was $92,029.39 and the median amount was $20,833. 
