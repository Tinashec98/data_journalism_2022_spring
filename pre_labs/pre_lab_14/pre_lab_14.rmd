...
**Answer** A dataframe of COVID tweets with 12 columns and 152,584rows.
...
**Answer**Standardizes them to "Dog", "dog", and "cat." DUplicates have been removed. 
...
**Answer** Sentences have been disintegrated so that each word occupies its own row. 
...
**Answer** A bar graph showing the frequency of words appears.It's not interesting because obvious artiels like "the" and "a" will always have a higher frequency. 
...
**Answer** Yes, more important keywords appear that could lead one to a story about the language people are using to talk about COVID. 
...
**Answer** It shows the frequency of unique words and how they compare in usage to other words. 
...
**Task** Run the following code and describe the results.
**Answer**The dataframe shows the top 10 phrases
...
**Task** Run the following code and describe the results.
**Answer**The datafram shows the top 10 word phrases for 2021 with phrases about the vaccine topping the list. 
...
**Task** Run the following code and describe the results.
**Answer**The top 10 phrases for both Dems and Republicans appear and are distinguished spearately. 
...
**Task** Run the following code and describe the results.
**Answer** The top 10 phrases from Republican House candidates appear and there are some inconsistencies in word spellings. 
...
**Answer** Words like partisan and issues being negative seems incorrect because without context, one can't conclude their nature. 
