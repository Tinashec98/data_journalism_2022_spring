...
**Answer**A county vaccination dataframe appears, with 13 columns and 11,397 rows.
...
**Answer** The dataframe has 2 columns and 26 rows. There's a NA row with a total of 284 and an "unknown" row with a total of 448. 
...
**Answer** The tibble shows a dataset that examines the "NA" county from the county_totals dataframe. This data represents vaccination records that didn't have the county of vaccination accounted for.
...
**Answer**The dataframe shows vaccination rates in PG County across a period of time and compares how many people were vaccinated each day. 
...
**Answer** The chart shows vaccination dates and how many people were fully vaccination on the date. 
...
**Answer**The chart shows counties and the nubmer of cases across time. Each county is color-coded. 
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** The unit of measurement on the y-axis has been
...
**Answer**Covid cases in Maryland and where they're concentrated. 
